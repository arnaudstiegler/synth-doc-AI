...
ground_truth = {
    'signature_doc.png': [{'field': 'Matter no', 'correct': '70104'}, {'field': 'Invoice #', 'correct': '172882'}],
    'email.png': [{'field': 'To', 'correct': 'gibillis@'}, {'field': 'From', 'correct': 'matt.adent@'}],
    'invoice.png': [{'field': 'Invoice date and time', 'correct': '12:48'},{'field': 'Payment Terms', 'correct': '30 days'}, {'field': 'Account Name', 'correct': 'XXXXX'}],
    'passport_card.jpg': [{'field': 'Date of Birth', 'correct': '14 DEC 1998'}, {'field': 'Surname', 'correct': 'LOPEZ'}],
    'drivers_license.jpg': [{'field': 'ID', 'correct': '123 456 789'}, {'field': 'DOB', 'correct': '08/31/2022'}]
}
