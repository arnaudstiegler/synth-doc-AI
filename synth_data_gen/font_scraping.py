...
def get_font_page_urls(listing_url):
    ...
    font_page_urls = [
        urljoin(scheme, link["href"]) for link in font_links if "href" in link.attrs
    ]
...
def main():
    ...
    start_page = 1
    end_page = 367  # Adjust this to the last page you want to scrape
    ...
    for page in range(start_page, end_page + 1):
        ...
        for url in font_page_urls:
            ...
            download_and_extract_zip(
                download_link,
                f"/Users/arnaudstiegler/llm-table-extraction/synth_data_gen/templates/fonts/temp",
                f'/Users/arnaudstiegler/llm-table-extraction/synth_data_gen/templates/fonts/{url.split("?f=")[-1]}',
            )
